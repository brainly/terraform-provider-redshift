...
func redshiftDatasharePrivilege() *schema.Resource {
	return &schema.Resource{
		...
		CreateWithoutTimeout: RedshiftResourceFunc(resourceRedshiftDatasharePrivilegeCreate),
		ReadWithoutTimeout:   RedshiftResourceFunc(resourceRedshiftDatasharePrivilegeRead),
		DeleteWithoutTimeout: RedshiftResourceFunc(resourceRedshiftDatasharePrivilegeDelete),
