...
`,
		CreateWithoutTimeout: RedshiftResourceFunc(resourceRedshiftGroupCreate),
		ReadWithoutTimeout:   RedshiftResourceFunc(resourceRedshiftGroupRead),
		UpdateWithoutTimeout: RedshiftResourceFunc(resourceRedshiftGroupUpdate),
